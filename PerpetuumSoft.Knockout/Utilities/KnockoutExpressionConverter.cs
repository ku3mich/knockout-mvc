...
{
    public sealed class KnockoutExpressionConverter
    {
        ...
        private string VisitMemberAccess(MemberExpression m)
        {
        ...
        private string VisitMemberAccess(Expression obj, string member)
        {
            ...
            string prefix = own == "" ? "" : own + (member=="length"? "()" : "" ) +".";
        ...
        private string VisitUnary(UnaryExpression u, string sign)
        {
            string operand = Visit(u.Operand);
            return sign + operand;
        }

        private string VisitBinary(BinaryExpression b, string sign)
        {
        ...
        private string VisitConditional(ConditionalExpression c)
        {
        ...
        private string VisitParameter(ParameterExpression p)
        {
        ...
        private string VisitTypeIs(TypeBinaryExpression b)
        {
            throw new NotSupportedException();
        }
        ...
        private ReadOnlyCollection<string> VisitExpressionList(ReadOnlyCollection<Expression> original)
        {
            throw new NotSupportedException();
        }

        private string VisitMemberAssignment(MemberAssignment assignment)
        {
            throw new NotSupportedException();
        }

        private string VisitMemberMemberBinding(MemberMemberBinding binding)
        {
            throw new NotSupportedException();
        }

        private string VisitMemberListBinding(MemberListBinding binding)
        {
            throw new NotSupportedException();
        }

        private IEnumerable<string> VisitBindingList(ReadOnlyCollection<MemberBinding> original)
        {
            throw new NotSupportedException();
        }

        private string VisitNew(NewExpression nex)
        {
            throw new NotSupportedException();
        }

        private string VisitMemberInit(MemberInitExpression init)
        {
            throw new NotSupportedException();
        }

        private string VisitListInit(ListInitExpression init)
        {
            throw new NotSupportedException();
        }

        private string VisitNewArray(NewArrayExpression na)
        {
            throw new NotSupportedException();
        }

        private string VisitInvocation(InvocationExpression iv)
        {
            throw new NotSupportedException();
        }
    }
