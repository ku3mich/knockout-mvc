...
namespace PerpetuumSoft.Knockout
{
    ...
    {
        protected KnockoutRegionContext(ViewContext viewContext, string ViewModelName = "viewModel", string JQSelector = null)
            : base(viewContext, ViewModelName, JQSelector)
        {
            if (viewContext == null)
